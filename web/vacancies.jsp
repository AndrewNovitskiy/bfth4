            ...
            <c:if test="${not empty requestScope.vacancies}">
                <c:forEach items="${requestScope.vacancies}" var="vacancy">
                    <div class="vacancyblock">
                        <div>
                            <span><a href="${pageContext.request.contextPath}/controller?command=vacancy&id=${vacancy.vacancyId}" class="vacancytitle">${vacancy.position}</a></span>
                        ...
                        <span><a href="${pageContext.request.contextPath}/controller?command=vacancy&id=${vacancy.vacancyId}" class="vacancymoreinfo">More Info...</a></span>
                    </div>
                </c:forEach>
            </c:if>
